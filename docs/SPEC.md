...
| 12 | doplněná funkce | Aplikace nikde neřekne, jak se hraje | Dialog **Jak se hraje** (od #13 v nabídce **⋮**) — kolo v šesti krocích s kreslenými ilustracemi, konec kola i hry a dovětek o hře ve třech | Appka umí počítat, ale pravidla nechává na krabici. Ilustrace jsou **SVG kreslené v kódu**, ne skeny — grafika Dixitu je autorsky chráněná a stažené obrázky by rozbily rozpočet offline cache (AD-10). |

| 13 | doplněná funkce | Sestavu hráčů nešlo vyměnit jinak než smazáním hráče po hráči (12× karta + 12× potvrzení), takže dialog sestavy z #11 byl dosažitelný jen jednou | **Nová hra** je v nabídce **⋮** dostupná i s neprázdným seznamem a otevře dialog sestavy; horní lišta se zredukovala na *Další hra*, ikonu **↺** a **⋮** | Chyběla zkratka, ne funkce. Čtvrtá akce by lištu prodloužila o další řádek (`.top-bar-actions` je sloupec), takže se obojí řešilo jedním zásahem. `confirmSetup()` sestavu odjakživa **nahrazuje**, takže nová akce ve stavu nebyla potřeba; *Zrušit* nechá starou partu netknutou a potvrzení kryje **Vrátit** (viz `DEV.md`, AD-18). |
